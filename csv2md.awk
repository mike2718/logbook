...
NF > 0 && NR > 1 {
        ...
        split($48, time_on, ":")
        split($49, time_off, ":")
        printf "| **%u** | %s %u %u | %02u%02u | %02u%02u | `%s` | %.3f | %.3f | %s | %s | %s | %s | %s | %s | %s | %s |\n", $61, month_to_english_abbreviation(qso_date[5] qso_date[6]), qso_date[7] qso_date[8], qso_date[1] qso_date[2] qso_date[3] qso_date[4], time_on[1], time_on[2], time_off[1], time_off[2], $5, $57, $13, $19, $36, $35, ($50 == "" ? "" : $50 "W"), ($37 == "" ? "" : $37 "W"), $22, ($63 == "Y" ? "✓" : ""), ($26 == "Y" ? "✓" : "")
}
